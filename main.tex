...
\title[CVE-2024-3094]{CVE-2024-3094: XZ Backdoor} % The short title in the optional parameter appears at the bottom of every slide, the full title in the main parameter is only on the title page
...
\include{sections/1-CVE.tex}
\include{sections/2-Introduction.tex}
\include{sections/3-appendice.tex}
...
\begin{frame}[plain] 
	...
	\end{center}
	\begin{itemize}
		\item \href{https://nvd.nist.gov/vuln/detail/CVE-2024-3094}{https://nvd.nist.gov/vuln/detail/CVE-2024-3094}
		\item \href{https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2024-3094}{https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2024-3094}
		\item \href{https://ubuntu.com/security/CVE-2024-3094}{https://ubuntu.com/security/CVE-2024-3094}
		\item \href{https://pentest-tools.com/blog/xz-utils-backdoor-cve-2024-3094}{https://pentest-tools.com/blog/xz-utils-backdoor-cve-2024-3094}
		\item \href{https://mastodon.social/@AndresFreundTec/112180083704606941}{https://mastodon.social/@AndresFreundTec/112180083704606941}
		\item \href{https://github.com/AndreaCicca/Sicurezza-Informatica-Presentazione/}(https://github.com/AndreaCicca/Sicurezza-Informatica-Presentazione/)
	\end{itemize}
\end{frame}
